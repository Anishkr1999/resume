            ...
            <div className='row my-5'>
                ...
                <div className='row col-sm-4 align-items-center  mx-auto'>
                    {/* <div className='col-sm-6 my-3  col-3'>
                        <a href="#" rel="noreferrer" target="_blank">  <i class="fab fa-facebook social" style={{ fontSize: "55px", color: "blue" }}></i></a>
                    </div> */}
                    ...
                    {/* <div className='col-sm-6 my-3 col-3'>
                        <a href="#" rel="noreferrer" target="_blank">   <i class="fa fa-github social" style={{ fontSize: "55px", color: "coral" }}></i></a>
